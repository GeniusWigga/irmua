    ...
    return (
      <div className="site-container portfolio">
        <div className="grid">
          ...
          <div className="grid-item"><img src={brideImage6} /></div>
          <div className="grid-item"><img src={brideImage4} /></div>
          <div className="grid-item"><img src={brideImage7} /></div>
          <div className="grid-item"><img src={haircut1} /></div>
          <div className="grid-item"><img src={haircut2} /></div>
          <div className="grid-item"><img src={haircut3} /></div>
          <div className="grid-item"><img src={haircut4} /></div>
          <div className="grid-item"><img src={makeup1} /></div>
          <div className="grid-item"><img src={makeup2} /></div>
          <div className="grid-item"><img src={makeup3} /></div>
          <div className="grid-item"><img src={makeup4} /></div>
          <div className="grid-item"><img src={shooting1} /></div>
          <div className="grid-item"><img src={shooting2} /></div>
          <div className="grid-item"><img src={shooting3} /></div>
          <div className="grid-item"><img src={shooting4} /></div>
          <div className="grid-item"><img src={beforeAfter1} /></div>
          <div className="grid-item"><img src={beforeAfter2} /></div>
          <div className="grid-item"><img src={beforeAfter3} /></div>
          <div className="grid-item"><img src={beforeAfter4} /></div>
        </div>
      </div>
    );
  }
